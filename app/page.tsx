...
const TobCraftxzy = () => {
  return (
    <div className="">
      ...
      <section className="flex items-center justify-center transition-opacity ease-in duration-700 opacity-100 mb-16 pb-5 content">
        <h1 className="bg-gradient-to-r text-7xl from-[#1bd8e5] to-[#00dd51] dark:from-[#00eeff] dark:to-[#00ff5e] text-transparent bg-clip-text md:flex hidden text-center">
          Hi! I'm Tobias
        </h1>
        <h1 className="bg-gradient-to-r text-7xl dark:from-[#00eeff] dark:to-[#00ff5e] text-transparent bg-clip-text md:hidden flex text-center">
          Hi! I'm
          <br />
          Tobias
        </h1>
