  ...
  return (
    <div className="w-full md:w-[40vw] lg:w-[18vw] cursor-pointer skill">
      ...
      <div className="flex justify-center w-full mt-2">
        <div className="mt-2 rounded-full w-[100%] bg-[#566778] dark:bg-slate-900 h-4 overflow-hidden">
          <div
          ...
          >
            <div className="w-full bg-[rgb(10,37,64)] h-4 relative dark:bg-slate-800 rounded-full skillani"></div>
          </div>
        </div>
      </div>
    </div>
